...
import {
  createHotContext
} from "/build/_shared/chunk-ATEPPW6H.js";
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id2) => {
    window.$RefreshRuntime$.register(type, '"app/routes/_index.tsx"' + id2);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1728904051641";
}
var contractABI = ["event TokensPurchased(address indexed purchaser, uint256 amountSpent, uint256 tokensMinted)", "event SaleFinalized()", "function buyTokens() external payable", "function finalizeSale() external", "function isSaleActive() public view returns (bool)", "function cap() public view returns (uint256)", "function saleStart() public view returns (uint256)", "function saleEnd() public view returns (uint256)", "function rate() public view returns (uint256)", "function totalSupply() public view returns (uint256)"];
var contractAddress = "YOUR_CONTRACT_ADDRESS_HERE";
function Index() {
  _s();
  ...
  const [saleActive, setSaleActive] = (0, import_react.useState)(false);
  const [cap, setCap] = (0, import_react.useState)("");
  const [totalSupply, setTotalSupply] = (0, import_react.useState)("");
  const [saleStart, setSaleStart] = (0, import_react.useState)("");
  const [saleEnd, setSaleEnd] = (0, import_react.useState)("");
  const [rate, setRate] = (0, import_react.useState)("");
  const [amount, setAmount] = (0, import_react.useState)("");
  (0, import_react.useEffect)(() => {
    const init2 = async () => {
      if (typeof window.ethereum !== "undefined") {
        const provider2 = new ethers_exports.BrowserProvider(window.ethereum);
        const signer = await provider2.getSigner();
        const contract2 = new ethers_exports.Contract(contractAddress, contractABI, signer);
        setProvider(provider2);
        setContract(contract2);
        setAccount(await signer.getAddress());
        const active = await contract2.isSaleActive();
        const capValue = await contract2.cap();
        const supplyValue = await contract2.totalSupply();
        const startValue = await contract2.saleStart();
        const endValue = await contract2.saleEnd();
        const rateValue = await contract2.rate();
        setSaleActive(active);
        setCap(ethers_exports.formatEther(capValue));
        setTotalSupply(ethers_exports.formatEther(supplyValue));
        setSaleStart(new Date(Number(startValue) * 1e3).toLocaleString());
        setSaleEnd(new Date(Number(endValue) * 1e3).toLocaleString());
        setRate(rateValue.toString());
        contract2.on("TokensPurchased", (purchaser, amountSpent, tokensMinted) => {
          console.log(`Tokens Purchased: ${ethers_exports.formatEther(tokensMinted)} by ${purchaser}`);
          contract2.totalSupply().then((newSupply) => {
            setTotalSupply(ethers_exports.formatEther(newSupply));
          });
        });
    ...
    if (contract && amount) {
      try {
        const tx = await contract.buyTokens({
          value: ethers_exports.parseEther(amount)
        });
        await tx.wait();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "container mx-auto px-4 py-8", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-4xl font-bold mb-8 text-center", children: "Crowdfunding Dapp" }, void 0, false, {
      fileName: "app/routes/_index.tsx",
      lineNumber: 97,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "bg-white bg-opacity-10 rounded-lg p-6 backdrop-blur-lg shadow-xl", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Connected Account:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 99,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Sale Active:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 100,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Cap:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 101,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Total Supply:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 102,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Sale Start:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 103,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Sale End:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 104,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "mb-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "font-semibold", children: "Rate:" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 105,
          columnNumber: 29
        }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-8", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", value: amount, onChange: (e) => setAmount(e.target.value), placeholder: "Amount in ETH", className: "w-full p-2 mb-4 bg-white bg-opacity-20 rounded text-white placeholder-gray-300" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 107,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { onClick: buyTokens, disabled: !saleActive, className: "w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-bold py-2 px-4 rounded hover:from-purple-600 hover:to-blue-600 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed", children: "Buy Tokens" }, void 0, false, {
          fileName: "app/routes/_index.tsx",
          lineNumber: 108,
          columnNumber: 11
        }, this)
...
_s(Index, "O6k/hDl7dMYlCnraJK81d5SYT78=");
_c = Index;
var _c;
$RefreshReg$(_c, "Index");
...
*/
//# sourceMappingURL=/build/routes/_index-3DSXZWC5.js.map
